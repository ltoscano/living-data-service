...
const LivingDataService = () => {
  ...
  // Keycloak error screen - show if Keycloak failed and user is not authenticated
  if (!isAuthenticated && keycloakEnabled && new URLSearchParams(window.location.search).has('error')) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#fbf7f1' }}>
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-6">There was a problem with the authentication process.</p>
            </div>
            <button
              onClick={() => window.location.href = '/auth/keycloak/login'}
  ...
  // Login screen - show only if not authenticated AND Keycloak is disabled
  // If Keycloak is enabled, we should never show the login screen (auto-redirect happens in useAuth)
              ...
              {new URLSearchParams(window.location.search).has('error') && (
                <div className="mt-4 p-3 bg-red-100 border border-red-300 rounded-lg">
                  <p className="text-red-700 text-sm">
                    Authentication failed. Please try again or use your application account below.
                  </p>
                </div>
              )}
            </div>
...
{keycloakEnabled ? (
              // Login ibrido: Keycloak + account applicativi
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500">Or use application account</span>
                  </div>
                </div>
